...
// checks if the RedemptionsBySettlementDatePage type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RedemptionsBySettlementDatePage{}

// RedemptionsBySettlementDatePage Return paginated redemptions by settlement date.
type RedemptionsBySettlementDatePage struct {
	// List of redemptions.
	Data []RedemptionsBySettlementDateResponse `json:"data,omitempty"`
...
type _RedemptionsBySettlementDatePage RedemptionsBySettlementDatePage
...
func NewRedemptionsBySettlementDatePage(count int32, endIndex int64, isMore bool, startIndex int64) *RedemptionsBySettlementDatePage {
	this := RedemptionsBySettlementDatePage{}
	this.Count = count
...
func (o *RedemptionsBySettlementDatePage) GetData() []RedemptionsBySettlementDateResponse {
	if o == nil || IsNil(o.Data) {
		var ret []RedemptionsBySettlementDateResponse
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []RedemptionsBySettlementDateResponse and assigns it to the Data field.
...
func (o RedemptionsBySettlementDatePage) MarshalJSON() ([]byte, error) {
...
func (o RedemptionsBySettlementDatePage) ToMap() (map[string]interface{}, error) {
...
func (o *RedemptionsBySettlementDatePage) UnmarshalJSON(data []byte) (err error) {
	...
	*o = RedemptionsBySettlementDatePage(varRedemptionsBySettlementDatePage)

	return err
}

type NullableRedemptionsBySettlementDatePage struct {
	value *RedemptionsBySettlementDatePage
	isSet bool
}

func (v NullableRedemptionsBySettlementDatePage) Get() *RedemptionsBySettlementDatePage {
	return v.value
}

func (v *NullableRedemptionsBySettlementDatePage) Set(val *RedemptionsBySettlementDatePage) {
	v.value = val
	v.isSet = true
}

func (v NullableRedemptionsBySettlementDatePage) IsSet() bool {
	return v.isSet
}

func (v *NullableRedemptionsBySettlementDatePage) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRedemptionsBySettlementDatePage(val *RedemptionsBySettlementDatePage) *NullableRedemptionsBySettlementDatePage {
	return &NullableRedemptionsBySettlementDatePage{value: val, isSet: true}
}

func (v NullableRedemptionsBySettlementDatePage) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRedemptionsBySettlementDatePage) UnmarshalJSON(src []byte) error {
	v.isSet = true
