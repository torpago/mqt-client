...
// checks if the AuthControlListResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AuthControlListResponse{}

// AuthControlListResponse struct for AuthControlListResponse
type AuthControlListResponse struct {
	...
	Data []AuthControlResponse `json:"data,omitempty"`
...
// SetData gets a reference to the given []AuthControlResponse and assigns it to the Data field.
...
func (o AuthControlListResponse) MarshalJSON() ([]byte, error) {
...
func (o AuthControlListResponse) ToMap() (map[string]interface{}, error) {
...
type NullableAuthControlListResponse struct {
	value *AuthControlListResponse
	isSet bool
}

func (v NullableAuthControlListResponse) Get() *AuthControlListResponse {
	return v.value
}

func (v *NullableAuthControlListResponse) Set(val *AuthControlListResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableAuthControlListResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableAuthControlListResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAuthControlListResponse(val *AuthControlListResponse) *NullableAuthControlListResponse {
	return &NullableAuthControlListResponse{value: val, isSet: true}
}

func (v NullableAuthControlListResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAuthControlListResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
