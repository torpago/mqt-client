...
// checks if the MerchantGroupListResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MerchantGroupListResponse{}

// MerchantGroupListResponse struct for MerchantGroupListResponse
type MerchantGroupListResponse struct {
	...
	Data []MerchantGroupResponse `json:"data,omitempty"`
...
func NewMerchantGroupListResponse() *MerchantGroupListResponse {
	this := MerchantGroupListResponse{}
...
// SetData gets a reference to the given []MerchantGroupResponse and assigns it to the Data field.
...
func (o MerchantGroupListResponse) MarshalJSON() ([]byte, error) {
...
func (o MerchantGroupListResponse) ToMap() (map[string]interface{}, error) {
...
type NullableMerchantGroupListResponse struct {
	value *MerchantGroupListResponse
	isSet bool
}

func (v NullableMerchantGroupListResponse) Get() *MerchantGroupListResponse {
	return v.value
}

func (v *NullableMerchantGroupListResponse) Set(val *MerchantGroupListResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableMerchantGroupListResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableMerchantGroupListResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMerchantGroupListResponse(val *MerchantGroupListResponse) *NullableMerchantGroupListResponse {
	return &NullableMerchantGroupListResponse{value: val, isSet: true}
}

func (v NullableMerchantGroupListResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMerchantGroupListResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
