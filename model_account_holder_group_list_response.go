...
// checks if the AccountHolderGroupListResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AccountHolderGroupListResponse{}

// AccountHolderGroupListResponse struct for AccountHolderGroupListResponse
type AccountHolderGroupListResponse struct {
	...
	Data []AccountHolderGroupResponse `json:"data,omitempty"`
...
func NewAccountHolderGroupListResponse() *AccountHolderGroupListResponse {
	this := AccountHolderGroupListResponse{}
...
func (o *AccountHolderGroupListResponse) GetData() []AccountHolderGroupResponse {
	if o == nil || IsNil(o.Data) {
		var ret []AccountHolderGroupResponse
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []AccountHolderGroupResponse and assigns it to the Data field.
...
func (o AccountHolderGroupListResponse) MarshalJSON() ([]byte, error) {
...
func (o AccountHolderGroupListResponse) ToMap() (map[string]interface{}, error) {
...
type NullableAccountHolderGroupListResponse struct {
	value *AccountHolderGroupListResponse
	isSet bool
}

func (v NullableAccountHolderGroupListResponse) Get() *AccountHolderGroupListResponse {
	return v.value
}

func (v *NullableAccountHolderGroupListResponse) Set(val *AccountHolderGroupListResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableAccountHolderGroupListResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableAccountHolderGroupListResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAccountHolderGroupListResponse(val *AccountHolderGroupListResponse) *NullableAccountHolderGroupListResponse {
	return &NullableAccountHolderGroupListResponse{value: val, isSet: true}
}

func (v NullableAccountHolderGroupListResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAccountHolderGroupListResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
