...
// checks if the PaymentSchedulePage type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PaymentSchedulePage{}

// PaymentSchedulePage Returns paginated information for multiple payment schedules.
type PaymentSchedulePage struct {
	// Number of resources returned.
	Count int32 `json:"count"`
	// List of payment schedules.
	Data []PaymentScheduleResponse `json:"data"`
...
type _PaymentSchedulePage PaymentSchedulePage
...
func (o PaymentSchedulePage) MarshalJSON() ([]byte, error) {
...
func (o PaymentSchedulePage) ToMap() (map[string]interface{}, error) {
...
func (o *PaymentSchedulePage) UnmarshalJSON(data []byte) (err error) {
	...
	varPaymentSchedulePage := _PaymentSchedulePage{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPaymentSchedulePage)

	if err != nil {
		return err
	}

	*o = PaymentSchedulePage(varPaymentSchedulePage)

	return err
}

type NullablePaymentSchedulePage struct {
	value *PaymentSchedulePage
	isSet bool
}

func (v NullablePaymentSchedulePage) Get() *PaymentSchedulePage {
	return v.value
}

func (v *NullablePaymentSchedulePage) Set(val *PaymentSchedulePage) {
	v.value = val
	v.isSet = true
}

func (v NullablePaymentSchedulePage) IsSet() bool {
	return v.isSet
}

func (v *NullablePaymentSchedulePage) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaymentSchedulePage(val *PaymentSchedulePage) *NullablePaymentSchedulePage {
	return &NullablePaymentSchedulePage{value: val, isSet: true}
}

func (v NullablePaymentSchedulePage) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePaymentSchedulePage) UnmarshalJSON(src []byte) error {
	v.isSet = true
