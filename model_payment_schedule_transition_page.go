...
type _PaymentScheduleTransitionPage PaymentScheduleTransitionPage
...
func (o *PaymentScheduleTransitionPage) UnmarshalJSON(data []byte) (err error) {
	...
	varPaymentScheduleTransitionPage := _PaymentScheduleTransitionPage{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPaymentScheduleTransitionPage)

	if err != nil {
		return err
	}

	*o = PaymentScheduleTransitionPage(varPaymentScheduleTransitionPage)
