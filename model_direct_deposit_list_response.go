...
// checks if the DirectDepositListResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DirectDepositListResponse{}

// DirectDepositListResponse struct for DirectDepositListResponse
type DirectDepositListResponse struct {
	Count *int32 `json:"count,omitempty"`
	Data []DirectDepositResponse `json:"data,omitempty"`
...
func NewDirectDepositListResponse() *DirectDepositListResponse {
	this := DirectDepositListResponse{}
...
// SetData gets a reference to the given []DirectDepositResponse and assigns it to the Data field.
...
func (o DirectDepositListResponse) MarshalJSON() ([]byte, error) {
...
func (o DirectDepositListResponse) ToMap() (map[string]interface{}, error) {
...
type NullableDirectDepositListResponse struct {
	value *DirectDepositListResponse
	isSet bool
}

func (v NullableDirectDepositListResponse) Get() *DirectDepositListResponse {
	return v.value
}

func (v *NullableDirectDepositListResponse) Set(val *DirectDepositListResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableDirectDepositListResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableDirectDepositListResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDirectDepositListResponse(val *DirectDepositListResponse) *NullableDirectDepositListResponse {
	return &NullableDirectDepositListResponse{value: val, isSet: true}
}

func (v NullableDirectDepositListResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDirectDepositListResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
