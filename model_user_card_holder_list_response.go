...
// checks if the UserCardHolderListResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UserCardHolderListResponse{}

// UserCardHolderListResponse struct for UserCardHolderListResponse
type UserCardHolderListResponse struct {
	...
	Data []CardHolderModel `json:"data,omitempty"`
...
func NewUserCardHolderListResponse() *UserCardHolderListResponse {
	this := UserCardHolderListResponse{}
...
// SetData gets a reference to the given []CardHolderModel and assigns it to the Data field.
...
func (o UserCardHolderListResponse) MarshalJSON() ([]byte, error) {
...
func (o UserCardHolderListResponse) ToMap() (map[string]interface{}, error) {
...
type NullableUserCardHolderListResponse struct {
	value *UserCardHolderListResponse
	isSet bool
}

func (v NullableUserCardHolderListResponse) Get() *UserCardHolderListResponse {
	return v.value
}

func (v *NullableUserCardHolderListResponse) Set(val *UserCardHolderListResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableUserCardHolderListResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableUserCardHolderListResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUserCardHolderListResponse(val *UserCardHolderListResponse) *NullableUserCardHolderListResponse {
	return &NullableUserCardHolderListResponse{value: val, isSet: true}
}

func (v NullableUserCardHolderListResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUserCardHolderListResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
