...
// checks if the CardGroupPage type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CardGroupPage{}

// CardGroupPage struct for CardGroupPage
type CardGroupPage struct {
	...
	Data []CardGroup `json:"data,omitempty"`
...
// SetData gets a reference to the given []CardGroup and assigns it to the Data field.
...
func (o CardGroupPage) MarshalJSON() ([]byte, error) {
...
func (o CardGroupPage) ToMap() (map[string]interface{}, error) {
...
type NullableCardGroupPage struct {
	value *CardGroupPage
	isSet bool
}

func (v NullableCardGroupPage) Get() *CardGroupPage {
	return v.value
}

func (v *NullableCardGroupPage) Set(val *CardGroupPage) {
	v.value = val
	v.isSet = true
}

func (v NullableCardGroupPage) IsSet() bool {
	return v.isSet
}

func (v *NullableCardGroupPage) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCardGroupPage(val *CardGroupPage) *NullableCardGroupPage {
	return &NullableCardGroupPage{value: val, isSet: true}
}

func (v NullableCardGroupPage) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCardGroupPage) UnmarshalJSON(src []byte) error {
	v.isSet = true
