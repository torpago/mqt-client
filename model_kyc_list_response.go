...
// checks if the KYCListResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &KYCListResponse{}

// KYCListResponse struct for KYCListResponse
type KYCListResponse struct {
	...
	Data []KycResponse `json:"data,omitempty"`
...
// SetData gets a reference to the given []KycResponse and assigns it to the Data field.
...
func (o KYCListResponse) MarshalJSON() ([]byte, error) {
...
func (o KYCListResponse) ToMap() (map[string]interface{}, error) {
...
type NullableKYCListResponse struct {
	value *KYCListResponse
	isSet bool
}

func (v NullableKYCListResponse) Get() *KYCListResponse {
	return v.value
}

func (v *NullableKYCListResponse) Set(val *KYCListResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableKYCListResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableKYCListResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableKYCListResponse(val *KYCListResponse) *NullableKYCListResponse {
	return &NullableKYCListResponse{value: val, isSet: true}
}

func (v NullableKYCListResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableKYCListResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
