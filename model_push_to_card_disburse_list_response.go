...
// checks if the PushToCardDisburseListResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PushToCardDisburseListResponse{}

// PushToCardDisburseListResponse struct for PushToCardDisburseListResponse
type PushToCardDisburseListResponse struct {
	Count *int32 `json:"count,omitempty"`
	Data []PushToCardDisbursementResponse `json:"data,omitempty"`
...
func NewPushToCardDisburseListResponse() *PushToCardDisburseListResponse {
	this := PushToCardDisburseListResponse{}
...
func (o *PushToCardDisburseListResponse) GetData() []PushToCardDisbursementResponse {
	if o == nil || IsNil(o.Data) {
		var ret []PushToCardDisbursementResponse
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []PushToCardDisbursementResponse and assigns it to the Data field.
...
func (o PushToCardDisburseListResponse) MarshalJSON() ([]byte, error) {
...
func (o PushToCardDisburseListResponse) ToMap() (map[string]interface{}, error) {
...
type NullablePushToCardDisburseListResponse struct {
	value *PushToCardDisburseListResponse
	isSet bool
}

func (v NullablePushToCardDisburseListResponse) Get() *PushToCardDisburseListResponse {
	return v.value
}

func (v *NullablePushToCardDisburseListResponse) Set(val *PushToCardDisburseListResponse) {
	v.value = val
	v.isSet = true
}

func (v NullablePushToCardDisburseListResponse) IsSet() bool {
	return v.isSet
}

func (v *NullablePushToCardDisburseListResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePushToCardDisburseListResponse(val *PushToCardDisburseListResponse) *NullablePushToCardDisburseListResponse {
	return &NullablePushToCardDisburseListResponse{value: val, isSet: true}
}

func (v NullablePushToCardDisburseListResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePushToCardDisburseListResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
