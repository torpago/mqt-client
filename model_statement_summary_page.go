...
// checks if the StatementSummaryPage type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &StatementSummaryPage{}

// StatementSummaryPage Return filtered transactions.
type StatementSummaryPage struct {
...
type _StatementSummaryPage StatementSummaryPage
...
func (o StatementSummaryPage) MarshalJSON() ([]byte, error) {
...
func (o StatementSummaryPage) ToMap() (map[string]interface{}, error) {
...
func (o *StatementSummaryPage) UnmarshalJSON(data []byte) (err error) {
	...
	varStatementSummaryPage := _StatementSummaryPage{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varStatementSummaryPage)

	if err != nil {
		return err
	}

	*o = StatementSummaryPage(varStatementSummaryPage)

	return err
}

type NullableStatementSummaryPage struct {
	value *StatementSummaryPage
	isSet bool
}

func (v NullableStatementSummaryPage) Get() *StatementSummaryPage {
	return v.value
}

func (v *NullableStatementSummaryPage) Set(val *StatementSummaryPage) {
	v.value = val
	v.isSet = true
}

func (v NullableStatementSummaryPage) IsSet() bool {
	return v.isSet
}

func (v *NullableStatementSummaryPage) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableStatementSummaryPage(val *StatementSummaryPage) *NullableStatementSummaryPage {
	return &NullableStatementSummaryPage{value: val, isSet: true}
}

func (v NullableStatementSummaryPage) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableStatementSummaryPage) UnmarshalJSON(src []byte) error {
	v.isSet = true
