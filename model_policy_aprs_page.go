...
// checks if the PolicyAprsPage type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PolicyAprsPage{}

// PolicyAprsPage List response details for paginated APR policies.
type PolicyAprsPage struct {
	// Number of resources returned.
	Count int32 `json:"count"`
	// One or more APR policies.
	Data []PolicyAprResponse `json:"data"`
...
type _PolicyAprsPage PolicyAprsPage
...
func (o PolicyAprsPage) MarshalJSON() ([]byte, error) {
...
func (o PolicyAprsPage) ToMap() (map[string]interface{}, error) {
...
func (o *PolicyAprsPage) UnmarshalJSON(data []byte) (err error) {
	...
	varPolicyAprsPage := _PolicyAprsPage{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPolicyAprsPage)

	if err != nil {
		return err
	}

	*o = PolicyAprsPage(varPolicyAprsPage)

	return err
}

type NullablePolicyAprsPage struct {
	value *PolicyAprsPage
	isSet bool
}

func (v NullablePolicyAprsPage) Get() *PolicyAprsPage {
	return v.value
}

func (v *NullablePolicyAprsPage) Set(val *PolicyAprsPage) {
	v.value = val
	v.isSet = true
}

func (v NullablePolicyAprsPage) IsSet() bool {
	return v.isSet
}

func (v *NullablePolicyAprsPage) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePolicyAprsPage(val *PolicyAprsPage) *NullablePolicyAprsPage {
	return &NullablePolicyAprsPage{value: val, isSet: true}
}

func (v NullablePolicyAprsPage) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePolicyAprsPage) UnmarshalJSON(src []byte) error {
	v.isSet = true
