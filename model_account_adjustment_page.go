...
// checks if the AccountAdjustmentPage type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AccountAdjustmentPage{}

// AccountAdjustmentPage Returns paginated account adjustments.
type AccountAdjustmentPage struct {
	// Number of resources returned.
	Count int32 `json:"count"`
	// Contains one or more account adjustments.
	Data []AccountAdjustmentResponse `json:"data"`
...
type _AccountAdjustmentPage AccountAdjustmentPage
...
func (o *AccountAdjustmentPage) GetData() []AccountAdjustmentResponse {
	if o == nil {
		var ret []AccountAdjustmentResponse
		return ret
	}
...
func (o AccountAdjustmentPage) MarshalJSON() ([]byte, error) {
...
func (o AccountAdjustmentPage) ToMap() (map[string]interface{}, error) {
...
func (o *AccountAdjustmentPage) UnmarshalJSON(data []byte) (err error) {
	...
	varAccountAdjustmentPage := _AccountAdjustmentPage{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAccountAdjustmentPage)

	if err != nil {
		return err
	}

	*o = AccountAdjustmentPage(varAccountAdjustmentPage)

	return err
}

type NullableAccountAdjustmentPage struct {
	value *AccountAdjustmentPage
	isSet bool
}

func (v NullableAccountAdjustmentPage) Get() *AccountAdjustmentPage {
	return v.value
}

func (v *NullableAccountAdjustmentPage) Set(val *AccountAdjustmentPage) {
	v.value = val
	v.isSet = true
}

func (v NullableAccountAdjustmentPage) IsSet() bool {
	return v.isSet
}

func (v *NullableAccountAdjustmentPage) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAccountAdjustmentPage(val *AccountAdjustmentPage) *NullableAccountAdjustmentPage {
	return &NullableAccountAdjustmentPage{value: val, isSet: true}
}

func (v NullableAccountAdjustmentPage) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAccountAdjustmentPage) UnmarshalJSON(src []byte) error {
	v.isSet = true
