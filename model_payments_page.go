...
// checks if the PaymentsPage type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PaymentsPage{}

// PaymentsPage Returns paginated payments
type PaymentsPage struct {
	// Number of resources returned.
	Count int32 `json:"count"`
	// Contains one or more payments on a credit account.
	Data []PaymentDetailResponse `json:"data"`
...
type _PaymentsPage PaymentsPage
...
func (o PaymentsPage) MarshalJSON() ([]byte, error) {
...
func (o PaymentsPage) ToMap() (map[string]interface{}, error) {
...
func (o *PaymentsPage) UnmarshalJSON(data []byte) (err error) {
	...
	*o = PaymentsPage(varPaymentsPage)

	return err
}

type NullablePaymentsPage struct {
	value *PaymentsPage
	isSet bool
}

func (v NullablePaymentsPage) Get() *PaymentsPage {
	return v.value
}

func (v *NullablePaymentsPage) Set(val *PaymentsPage) {
	v.value = val
	v.isSet = true
}

func (v NullablePaymentsPage) IsSet() bool {
	return v.isSet
}

func (v *NullablePaymentsPage) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaymentsPage(val *PaymentsPage) *NullablePaymentsPage {
	return &NullablePaymentsPage{value: val, isSet: true}
}

func (v NullablePaymentsPage) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePaymentsPage) UnmarshalJSON(src []byte) error {
	v.isSet = true
