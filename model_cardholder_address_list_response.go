...
// checks if the CardholderAddressListResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CardholderAddressListResponse{}

// CardholderAddressListResponse struct for CardholderAddressListResponse
type CardholderAddressListResponse struct {
	...
	Data []CardholderAddressResponse `json:"data,omitempty"`
...
func NewCardholderAddressListResponse() *CardholderAddressListResponse {
	this := CardholderAddressListResponse{}
...
// SetData gets a reference to the given []CardholderAddressResponse and assigns it to the Data field.
...
func (o CardholderAddressListResponse) MarshalJSON() ([]byte, error) {
...
func (o CardholderAddressListResponse) ToMap() (map[string]interface{}, error) {
...
type NullableCardholderAddressListResponse struct {
	value *CardholderAddressListResponse
	isSet bool
}

func (v NullableCardholderAddressListResponse) Get() *CardholderAddressListResponse {
	return v.value
}

func (v *NullableCardholderAddressListResponse) Set(val *CardholderAddressListResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableCardholderAddressListResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableCardholderAddressListResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCardholderAddressListResponse(val *CardholderAddressListResponse) *NullableCardholderAddressListResponse {
	return &NullableCardholderAddressListResponse{value: val, isSet: true}
}

func (v NullableCardholderAddressListResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCardholderAddressListResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
