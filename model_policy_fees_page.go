...
// checks if the PolicyFeesPage type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PolicyFeesPage{}

// PolicyFeesPage List response details for fee policies.
type PolicyFeesPage struct {
	// Number of resources returned.
	Count int32 `json:"count"`
	// One or more fee policies.
	Data []PolicyFeeResponse `json:"data"`
...
type _PolicyFeesPage PolicyFeesPage
...
func (o PolicyFeesPage) MarshalJSON() ([]byte, error) {
...
func (o PolicyFeesPage) ToMap() (map[string]interface{}, error) {
...
func (o *PolicyFeesPage) UnmarshalJSON(data []byte) (err error) {
	...
	varPolicyFeesPage := _PolicyFeesPage{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPolicyFeesPage)

	if err != nil {
		return err
	}

	*o = PolicyFeesPage(varPolicyFeesPage)

	return err
}

type NullablePolicyFeesPage struct {
	value *PolicyFeesPage
	isSet bool
}

func (v NullablePolicyFeesPage) Get() *PolicyFeesPage {
	return v.value
}

func (v *NullablePolicyFeesPage) Set(val *PolicyFeesPage) {
	v.value = val
	v.isSet = true
}

func (v NullablePolicyFeesPage) IsSet() bool {
	return v.isSet
}

func (v *NullablePolicyFeesPage) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePolicyFeesPage(val *PolicyFeesPage) *NullablePolicyFeesPage {
	return &NullablePolicyFeesPage{value: val, isSet: true}
}

func (v NullablePolicyFeesPage) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePolicyFeesPage) UnmarshalJSON(src []byte) error {
	v.isSet = true
