...
// checks if the BankTransferListResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BankTransferListResponse{}

// BankTransferListResponse struct for BankTransferListResponse
type BankTransferListResponse struct {
	...
	Data []BankTransferResponseModel `json:"data,omitempty"`
...
func (o *BankTransferListResponse) GetData() []BankTransferResponseModel {
	if o == nil || IsNil(o.Data) {
		var ret []BankTransferResponseModel
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []BankTransferResponseModel and assigns it to the Data field.
...
func (o BankTransferListResponse) ToMap() (map[string]interface{}, error) {
