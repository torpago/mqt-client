...
// AccountFundingAuthorizationReversalEvent struct for AccountFundingAuthorizationReversalEvent
type AccountFundingAuthorizationReversalEvent struct {
...
func NewAccountFundingAuthorizationReversalEvent(precedingRelatedTransactionToken string, amount float32) *AccountFundingAuthorizationReversalEvent {
	this := AccountFundingAuthorizationReversalEvent{}
	this.Amount = &amount
...
func (o AccountFundingAuthorizationReversalEvent) MarshalJSON() ([]byte, error) {
...
type NullableAccountFundingAuthorizationReversalEvent struct {
	value *AccountFundingAuthorizationReversalEvent
	isSet bool
}

func (v NullableAccountFundingAuthorizationReversalEvent) Get() *AccountFundingAuthorizationReversalEvent {
	return v.value
}

func (v *NullableAccountFundingAuthorizationReversalEvent) Set(val *AccountFundingAuthorizationReversalEvent) {
	v.value = val
	v.isSet = true
}

func (v NullableAccountFundingAuthorizationReversalEvent) IsSet() bool {
	return v.isSet
}

func (v *NullableAccountFundingAuthorizationReversalEvent) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAccountFundingAuthorizationReversalEvent(val *AccountFundingAuthorizationReversalEvent) *NullableAccountFundingAuthorizationReversalEvent {
	return &NullableAccountFundingAuthorizationReversalEvent{value: val, isSet: true}
}

func (v NullableAccountFundingAuthorizationReversalEvent) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAccountFundingAuthorizationReversalEvent) UnmarshalJSON(src []byte) error {
	v.isSet = true
