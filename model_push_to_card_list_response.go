...
// checks if the PushToCardListResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PushToCardListResponse{}

// PushToCardListResponse struct for PushToCardListResponse
...
// SetData gets a reference to the given []PushToCardResponse and assigns it to the Data field.
...
func (o PushToCardListResponse) MarshalJSON() ([]byte, error) {
...
func (o PushToCardListResponse) ToMap() (map[string]interface{}, error) {
...
type NullablePushToCardListResponse struct {
	value *PushToCardListResponse
	isSet bool
}

func (v NullablePushToCardListResponse) Get() *PushToCardListResponse {
	return v.value
}

func (v *NullablePushToCardListResponse) Set(val *PushToCardListResponse) {
	v.value = val
	v.isSet = true
}

func (v NullablePushToCardListResponse) IsSet() bool {
	return v.isSet
}

func (v *NullablePushToCardListResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePushToCardListResponse(val *PushToCardListResponse) *NullablePushToCardListResponse {
	return &NullablePushToCardListResponse{value: val, isSet: true}
}

func (v NullablePushToCardListResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePushToCardListResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
