...
// checks if the PolicyRewardPage type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PolicyRewardPage{}

// PolicyRewardPage List response details for reward policies.
type PolicyRewardPage struct {
	// Number of resources returned.
	Count int32 `json:"count"`
	// One or more reward policies.
	Data []PolicyRewardResponse `json:"data"`
...
type _PolicyRewardPage PolicyRewardPage
...
func (o PolicyRewardPage) MarshalJSON() ([]byte, error) {
...
func (o PolicyRewardPage) ToMap() (map[string]interface{}, error) {
...
func (o *PolicyRewardPage) UnmarshalJSON(data []byte) (err error) {
	...
	varPolicyRewardPage := _PolicyRewardPage{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPolicyRewardPage)

	if err != nil {
		return err
	}

	*o = PolicyRewardPage(varPolicyRewardPage)

	return err
}

type NullablePolicyRewardPage struct {
	value *PolicyRewardPage
	isSet bool
}

func (v NullablePolicyRewardPage) Get() *PolicyRewardPage {
	return v.value
}

func (v *NullablePolicyRewardPage) Set(val *PolicyRewardPage) {
	v.value = val
	v.isSet = true
}

func (v NullablePolicyRewardPage) IsSet() bool {
	return v.isSet
}

func (v *NullablePolicyRewardPage) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePolicyRewardPage(val *PolicyRewardPage) *NullablePolicyRewardPage {
	return &NullablePolicyRewardPage{value: val, isSet: true}
}

func (v NullablePolicyRewardPage) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePolicyRewardPage) UnmarshalJSON(src []byte) error {
	v.isSet = true
