...
// AuthorizationIncrementalEvent struct for AuthorizationIncrementalEvent
type AuthorizationIncrementalEvent struct {
...
func NewAuthorizationIncrementalEvent(precedingRelatedTransactionToken string, amount float32) *AuthorizationIncrementalEvent {
	this := AuthorizationIncrementalEvent{}
	this.Amount = &amount
...
func (o AuthorizationIncrementalEvent) MarshalJSON() ([]byte, error) {
...
type NullableAuthorizationIncrementalEvent struct {
	value *AuthorizationIncrementalEvent
	isSet bool
}

func (v NullableAuthorizationIncrementalEvent) Get() *AuthorizationIncrementalEvent {
	return v.value
}

func (v *NullableAuthorizationIncrementalEvent) Set(val *AuthorizationIncrementalEvent) {
	v.value = val
	v.isSet = true
}

func (v NullableAuthorizationIncrementalEvent) IsSet() bool {
	return v.isSet
}

func (v *NullableAuthorizationIncrementalEvent) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAuthorizationIncrementalEvent(val *AuthorizationIncrementalEvent) *NullableAuthorizationIncrementalEvent {
	return &NullableAuthorizationIncrementalEvent{value: val, isSet: true}
}

func (v NullableAuthorizationIncrementalEvent) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAuthorizationIncrementalEvent) UnmarshalJSON(src []byte) error {
	v.isSet = true
