...
// checks if the BundleResponsePage type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BundleResponsePage{}

// BundleResponsePage Returns paginated bundles.
type BundleResponsePage struct {
...
type _BundleResponsePage BundleResponsePage
...
func (o BundleResponsePage) MarshalJSON() ([]byte, error) {
...
func (o BundleResponsePage) ToMap() (map[string]interface{}, error) {
...
func (o *BundleResponsePage) UnmarshalJSON(data []byte) (err error) {
	...
	varBundleResponsePage := _BundleResponsePage{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varBundleResponsePage)

	if err != nil {
		return err
	}

	*o = BundleResponsePage(varBundleResponsePage)

	return err
}

type NullableBundleResponsePage struct {
	value *BundleResponsePage
	isSet bool
}

func (v NullableBundleResponsePage) Get() *BundleResponsePage {
	return v.value
}

func (v *NullableBundleResponsePage) Set(val *BundleResponsePage) {
	v.value = val
	v.isSet = true
}

func (v NullableBundleResponsePage) IsSet() bool {
	return v.isSet
}

func (v *NullableBundleResponsePage) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBundleResponsePage(val *BundleResponsePage) *NullableBundleResponsePage {
	return &NullableBundleResponsePage{value: val, isSet: true}
}

func (v NullableBundleResponsePage) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBundleResponsePage) UnmarshalJSON(src []byte) error {
	v.isSet = true
