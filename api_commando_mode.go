...
type CommandoModeAPIPostCommandomodesRequest struct {
	ctx context.Context
	ApiService *CommandoModeAPIService
	commandoModeRequest *CommandoModeRequest
}

func (r CommandoModeAPIPostCommandomodesRequest) CommandoModeRequest(commandoModeRequest CommandoModeRequest) CommandoModeAPIPostCommandomodesRequest {
	r.commandoModeRequest = &commandoModeRequest
	return r
}

func (r CommandoModeAPIPostCommandomodesRequest) Execute() (*CommandoModeResponse, *http.Response, error) {
	return r.ApiService.PostCommandomodesExecute(r)
}

/*
PostCommandomodes Create Commando Mode control set

Create a Commando Mode control set.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return CommandoModeAPIPostCommandomodesRequest
*/
func (a *CommandoModeAPIService) PostCommandomodes(ctx context.Context) CommandoModeAPIPostCommandomodesRequest {
	return CommandoModeAPIPostCommandomodesRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return CommandoModeResponse
func (a *CommandoModeAPIService) PostCommandomodesExecute(r CommandoModeAPIPostCommandomodesRequest) (*CommandoModeResponse, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "CommandoModeAPIService.PostCommandomodes")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
	...
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.commandoModeRequest == nil {
		return localVarReturnValue, nil, reportError("commandoModeRequest is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.commandoModeRequest
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, nil, err
	}
