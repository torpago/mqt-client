...
// PindebitAuthorizationReversalEvent struct for PindebitAuthorizationReversalEvent
type PindebitAuthorizationReversalEvent struct {
...
func NewPindebitAuthorizationReversalEvent(precedingRelatedTransactionToken string, amount float32) *PindebitAuthorizationReversalEvent {
	this := PindebitAuthorizationReversalEvent{}
	this.Amount = &amount
...
func (o PindebitAuthorizationReversalEvent) MarshalJSON() ([]byte, error) {
...
type NullablePindebitAuthorizationReversalEvent struct {
	value *PindebitAuthorizationReversalEvent
	isSet bool
}

func (v NullablePindebitAuthorizationReversalEvent) Get() *PindebitAuthorizationReversalEvent {
	return v.value
}

func (v *NullablePindebitAuthorizationReversalEvent) Set(val *PindebitAuthorizationReversalEvent) {
	v.value = val
	v.isSet = true
}

func (v NullablePindebitAuthorizationReversalEvent) IsSet() bool {
	return v.isSet
}

func (v *NullablePindebitAuthorizationReversalEvent) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePindebitAuthorizationReversalEvent(val *PindebitAuthorizationReversalEvent) *NullablePindebitAuthorizationReversalEvent {
	return &NullablePindebitAuthorizationReversalEvent{value: val, isSet: true}
}

func (v NullablePindebitAuthorizationReversalEvent) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePindebitAuthorizationReversalEvent) UnmarshalJSON(src []byte) error {
	v.isSet = true
