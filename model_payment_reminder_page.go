...
// checks if the PaymentReminderPage type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PaymentReminderPage{}

// PaymentReminderPage Return payment reminders.
type PaymentReminderPage struct {
	// Number of resources returned.
	Count int32 `json:"count"`
	// Contains payment reminders on a credit account statement. Can be zero if none exist for the given statement.
	Data []PaymentReminderResponse `json:"data"`
...
type _PaymentReminderPage PaymentReminderPage
...
func (o *PaymentReminderPage) GetData() []PaymentReminderResponse {
	if o == nil {
		var ret []PaymentReminderResponse
		return ret
	}
...
func (o PaymentReminderPage) MarshalJSON() ([]byte, error) {
...
func (o PaymentReminderPage) ToMap() (map[string]interface{}, error) {
...
func (o *PaymentReminderPage) UnmarshalJSON(data []byte) (err error) {
	...
	varPaymentReminderPage := _PaymentReminderPage{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPaymentReminderPage)

	if err != nil {
		return err
	}

	*o = PaymentReminderPage(varPaymentReminderPage)

	return err
}

type NullablePaymentReminderPage struct {
	value *PaymentReminderPage
	isSet bool
}

func (v NullablePaymentReminderPage) Get() *PaymentReminderPage {
	return v.value
}

func (v *NullablePaymentReminderPage) Set(val *PaymentReminderPage) {
	v.value = val
	v.isSet = true
}

func (v NullablePaymentReminderPage) IsSet() bool {
	return v.isSet
}

func (v *NullablePaymentReminderPage) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaymentReminderPage(val *PaymentReminderPage) *NullablePaymentReminderPage {
	return &NullablePaymentReminderPage{value: val, isSet: true}
}

func (v NullablePaymentReminderPage) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePaymentReminderPage) UnmarshalJSON(src []byte) error {
	v.isSet = true
