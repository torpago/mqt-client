...
// checks if the CardTransitionListResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CardTransitionListResponse{}

// CardTransitionListResponse struct for CardTransitionListResponse
type CardTransitionListResponse struct {
	...
	Data []CardTransitionResponse `json:"data,omitempty"`
...
func NewCardTransitionListResponse() *CardTransitionListResponse {
	this := CardTransitionListResponse{}
...
func (o *CardTransitionListResponse) GetData() []CardTransitionResponse {
	if o == nil || IsNil(o.Data) {
		var ret []CardTransitionResponse
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []CardTransitionResponse and assigns it to the Data field.
...
func (o CardTransitionListResponse) MarshalJSON() ([]byte, error) {
...
func (o CardTransitionListResponse) ToMap() (map[string]interface{}, error) {
...
type NullableCardTransitionListResponse struct {
	value *CardTransitionListResponse
	isSet bool
}

func (v NullableCardTransitionListResponse) Get() *CardTransitionListResponse {
	return v.value
}

func (v *NullableCardTransitionListResponse) Set(val *CardTransitionListResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableCardTransitionListResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableCardTransitionListResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCardTransitionListResponse(val *CardTransitionListResponse) *NullableCardTransitionListResponse {
	return &NullableCardTransitionListResponse{value: val, isSet: true}
}

func (v NullableCardTransitionListResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCardTransitionListResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
