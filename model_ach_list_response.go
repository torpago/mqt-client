...
// checks if the ACHListResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ACHListResponse{}

// ACHListResponse struct for ACHListResponse
type ACHListResponse struct {
	...
	Data []BaseAchResponseModel `json:"data,omitempty"`
...
// SetData gets a reference to the given []BaseAchResponseModel and assigns it to the Data field.
...
func (o ACHListResponse) MarshalJSON() ([]byte, error) {
...
func (o ACHListResponse) ToMap() (map[string]interface{}, error) {
...
type NullableACHListResponse struct {
	value *ACHListResponse
	isSet bool
}

func (v NullableACHListResponse) Get() *ACHListResponse {
	return v.value
}

func (v *NullableACHListResponse) Set(val *ACHListResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableACHListResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableACHListResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableACHListResponse(val *ACHListResponse) *NullableACHListResponse {
	return &NullableACHListResponse{value: val, isSet: true}
}

func (v NullableACHListResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableACHListResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
