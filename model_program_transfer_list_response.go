...
// checks if the ProgramTransferListResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ProgramTransferListResponse{}

// ProgramTransferListResponse struct for ProgramTransferListResponse
type ProgramTransferListResponse struct {
	...
	Data []ProgramTransferResponse `json:"data,omitempty"`
...
func NewProgramTransferListResponse() *ProgramTransferListResponse {
	this := ProgramTransferListResponse{}
...
// SetData gets a reference to the given []ProgramTransferResponse and assigns it to the Data field.
...
func (o ProgramTransferListResponse) MarshalJSON() ([]byte, error) {
...
func (o ProgramTransferListResponse) ToMap() (map[string]interface{}, error) {
...
type NullableProgramTransferListResponse struct {
	value *ProgramTransferListResponse
	isSet bool
}

func (v NullableProgramTransferListResponse) Get() *ProgramTransferListResponse {
	return v.value
}

func (v *NullableProgramTransferListResponse) Set(val *ProgramTransferListResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableProgramTransferListResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableProgramTransferListResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableProgramTransferListResponse(val *ProgramTransferListResponse) *NullableProgramTransferListResponse {
	return &NullableProgramTransferListResponse{value: val, isSet: true}
}

func (v NullableProgramTransferListResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableProgramTransferListResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
