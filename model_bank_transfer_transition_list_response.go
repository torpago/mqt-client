...
// checks if the BankTransferTransitionListResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BankTransferTransitionListResponse{}

// BankTransferTransitionListResponse struct for BankTransferTransitionListResponse
type BankTransferTransitionListResponse struct {
	...
	Data []BankTransferTransitionResponseModel `json:"data,omitempty"`
...
func NewBankTransferTransitionListResponse() *BankTransferTransitionListResponse {
	this := BankTransferTransitionListResponse{}
...
// SetData gets a reference to the given []BankTransferTransitionResponseModel and assigns it to the Data field.
...
func (o BankTransferTransitionListResponse) MarshalJSON() ([]byte, error) {
...
func (o BankTransferTransitionListResponse) ToMap() (map[string]interface{}, error) {
...
type NullableBankTransferTransitionListResponse struct {
	value *BankTransferTransitionListResponse
	isSet bool
}

func (v NullableBankTransferTransitionListResponse) Get() *BankTransferTransitionListResponse {
	return v.value
}

func (v *NullableBankTransferTransitionListResponse) Set(val *BankTransferTransitionListResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableBankTransferTransitionListResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableBankTransferTransitionListResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBankTransferTransitionListResponse(val *BankTransferTransitionListResponse) *NullableBankTransferTransitionListResponse {
	return &NullableBankTransferTransitionListResponse{value: val, isSet: true}
}

func (v NullableBankTransferTransitionListResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBankTransferTransitionListResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
