...
// checks if the WebhookResponseModelListResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WebhookResponseModelListResponse{}

// WebhookResponseModelListResponse struct for WebhookResponseModelListResponse
type WebhookResponseModelListResponse struct {
	...
	Data []WebhookResponseModel `json:"data,omitempty"`
...
func NewWebhookResponseModelListResponse() *WebhookResponseModelListResponse {
	this := WebhookResponseModelListResponse{}
...
// SetData gets a reference to the given []WebhookResponseModel and assigns it to the Data field.
...
func (o WebhookResponseModelListResponse) MarshalJSON() ([]byte, error) {
...
func (o WebhookResponseModelListResponse) ToMap() (map[string]interface{}, error) {
...
type NullableWebhookResponseModelListResponse struct {
	value *WebhookResponseModelListResponse
	isSet bool
}

func (v NullableWebhookResponseModelListResponse) Get() *WebhookResponseModelListResponse {
	return v.value
}

func (v *NullableWebhookResponseModelListResponse) Set(val *WebhookResponseModelListResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableWebhookResponseModelListResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableWebhookResponseModelListResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWebhookResponseModelListResponse(val *WebhookResponseModelListResponse) *NullableWebhookResponseModelListResponse {
	return &NullableWebhookResponseModelListResponse{value: val, isSet: true}
}

func (v NullableWebhookResponseModelListResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWebhookResponseModelListResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
