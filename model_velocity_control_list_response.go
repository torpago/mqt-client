...
// checks if the VelocityControlListResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VelocityControlListResponse{}

// VelocityControlListResponse struct for VelocityControlListResponse
type VelocityControlListResponse struct {
	...
	Data []VelocityControlResponse `json:"data,omitempty"`
...
func NewVelocityControlListResponse() *VelocityControlListResponse {
	this := VelocityControlListResponse{}
...
func (o *VelocityControlListResponse) GetData() []VelocityControlResponse {
	if o == nil || IsNil(o.Data) {
		var ret []VelocityControlResponse
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []VelocityControlResponse and assigns it to the Data field.
...
func (o VelocityControlListResponse) MarshalJSON() ([]byte, error) {
...
func (o VelocityControlListResponse) ToMap() (map[string]interface{}, error) {
...
type NullableVelocityControlListResponse struct {
	value *VelocityControlListResponse
	isSet bool
}

func (v NullableVelocityControlListResponse) Get() *VelocityControlListResponse {
	return v.value
}

func (v *NullableVelocityControlListResponse) Set(val *VelocityControlListResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableVelocityControlListResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableVelocityControlListResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableVelocityControlListResponse(val *VelocityControlListResponse) *NullableVelocityControlListResponse {
	return &NullableVelocityControlListResponse{value: val, isSet: true}
}

func (v NullableVelocityControlListResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableVelocityControlListResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
