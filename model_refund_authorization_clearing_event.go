...
func NewRefundAuthorizationClearingEvent(precedingRelatedTransactionToken string, amount float32) *RefundAuthorizationClearingEvent {
...
func (o *RefundAuthorizationClearingEvent) GetPrecedingRelatedTransactionToken() string {
	if o == nil {
		var ret string
		return ret
	}
...
func (o *RefundAuthorizationClearingEvent) GetPrecedingRelatedTransactionTokenOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *RefundAuthorizationClearingEvent) SetPrecedingRelatedTransactionToken(v string) {
