...
type _AccountTransitionsPage AccountTransitionsPage
...
func (o *AccountTransitionsPage) UnmarshalJSON(data []byte) (err error) {
	...
	varAccountTransitionsPage := _AccountTransitionsPage{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAccountTransitionsPage)

	if err != nil {
		return err
	}

	*o = AccountTransitionsPage(varAccountTransitionsPage)
