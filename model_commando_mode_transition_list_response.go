...
// checks if the CommandoModeTransitionListResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CommandoModeTransitionListResponse{}

// CommandoModeTransitionListResponse struct for CommandoModeTransitionListResponse
type CommandoModeTransitionListResponse struct {
	...
	Data []CommandoModeTransitionResponse `json:"data,omitempty"`
...
func NewCommandoModeTransitionListResponse() *CommandoModeTransitionListResponse {
	this := CommandoModeTransitionListResponse{}
...
func (o *CommandoModeTransitionListResponse) GetData() []CommandoModeTransitionResponse {
	if o == nil || IsNil(o.Data) {
		var ret []CommandoModeTransitionResponse
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []CommandoModeTransitionResponse and assigns it to the Data field.
...
func (o CommandoModeTransitionListResponse) MarshalJSON() ([]byte, error) {
...
func (o CommandoModeTransitionListResponse) ToMap() (map[string]interface{}, error) {
...
type NullableCommandoModeTransitionListResponse struct {
	value *CommandoModeTransitionListResponse
	isSet bool
}

func (v NullableCommandoModeTransitionListResponse) Get() *CommandoModeTransitionListResponse {
	return v.value
}

func (v *NullableCommandoModeTransitionListResponse) Set(val *CommandoModeTransitionListResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableCommandoModeTransitionListResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableCommandoModeTransitionListResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCommandoModeTransitionListResponse(val *CommandoModeTransitionListResponse) *NullableCommandoModeTransitionListResponse {
	return &NullableCommandoModeTransitionListResponse{value: val, isSet: true}
}

func (v NullableCommandoModeTransitionListResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCommandoModeTransitionListResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
