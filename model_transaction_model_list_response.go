...
// checks if the TransactionModelListResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TransactionModelListResponse{}

// TransactionModelListResponse struct for TransactionModelListResponse
type TransactionModelListResponse struct {
	...
	Data []TransactionModel `json:"data,omitempty"`
...
func NewTransactionModelListResponse() *TransactionModelListResponse {
	this := TransactionModelListResponse{}
...
// SetData gets a reference to the given []TransactionModel and assigns it to the Data field.
...
func (o TransactionModelListResponse) MarshalJSON() ([]byte, error) {
...
func (o TransactionModelListResponse) ToMap() (map[string]interface{}, error) {
...
type NullableTransactionModelListResponse struct {
	value *TransactionModelListResponse
	isSet bool
}

func (v NullableTransactionModelListResponse) Get() *TransactionModelListResponse {
	return v.value
}

func (v *NullableTransactionModelListResponse) Set(val *TransactionModelListResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableTransactionModelListResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableTransactionModelListResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTransactionModelListResponse(val *TransactionModelListResponse) *NullableTransactionModelListResponse {
	return &NullableTransactionModelListResponse{value: val, isSet: true}
}

func (v NullableTransactionModelListResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTransactionModelListResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
