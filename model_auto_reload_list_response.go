...
// checks if the AutoReloadListResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AutoReloadListResponse{}

// AutoReloadListResponse struct for AutoReloadListResponse
type AutoReloadListResponse struct {
	...
	Data []AutoReloadResponseModel `json:"data,omitempty"`
...
func (o *AutoReloadListResponse) GetData() []AutoReloadResponseModel {
	if o == nil || IsNil(o.Data) {
		var ret []AutoReloadResponseModel
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []AutoReloadResponseModel and assigns it to the Data field.
...
func (o AutoReloadListResponse) MarshalJSON() ([]byte, error) {
...
func (o AutoReloadListResponse) ToMap() (map[string]interface{}, error) {
...
type NullableAutoReloadListResponse struct {
	value *AutoReloadListResponse
	isSet bool
}

func (v NullableAutoReloadListResponse) Get() *AutoReloadListResponse {
	return v.value
}

func (v *NullableAutoReloadListResponse) Set(val *AutoReloadListResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableAutoReloadListResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableAutoReloadListResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAutoReloadListResponse(val *AutoReloadListResponse) *NullableAutoReloadListResponse {
	return &NullableAutoReloadListResponse{value: val, isSet: true}
}

func (v NullableAutoReloadListResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAutoReloadListResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
