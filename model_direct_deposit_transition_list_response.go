...
// checks if the DirectDepositTransitionListResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DirectDepositTransitionListResponse{}

// DirectDepositTransitionListResponse struct for DirectDepositTransitionListResponse
type DirectDepositTransitionListResponse struct {
	Count *int32 `json:"count,omitempty"`
	Data []DirectDepositTransitionResponse `json:"data,omitempty"`
...
func NewDirectDepositTransitionListResponse() *DirectDepositTransitionListResponse {
	this := DirectDepositTransitionListResponse{}
...
func (o *DirectDepositTransitionListResponse) GetData() []DirectDepositTransitionResponse {
	if o == nil || IsNil(o.Data) {
		var ret []DirectDepositTransitionResponse
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []DirectDepositTransitionResponse and assigns it to the Data field.
...
func (o DirectDepositTransitionListResponse) MarshalJSON() ([]byte, error) {
...
func (o DirectDepositTransitionListResponse) ToMap() (map[string]interface{}, error) {
...
type NullableDirectDepositTransitionListResponse struct {
	value *DirectDepositTransitionListResponse
	isSet bool
}

func (v NullableDirectDepositTransitionListResponse) Get() *DirectDepositTransitionListResponse {
	return v.value
}

func (v *NullableDirectDepositTransitionListResponse) Set(val *DirectDepositTransitionListResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableDirectDepositTransitionListResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableDirectDepositTransitionListResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDirectDepositTransitionListResponse(val *DirectDepositTransitionListResponse) *NullableDirectDepositTransitionListResponse {
	return &NullableDirectDepositTransitionListResponse{value: val, isSet: true}
}

func (v NullableDirectDepositTransitionListResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDirectDepositTransitionListResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
