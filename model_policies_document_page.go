...
// checks if the PoliciesDocumentPage type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PoliciesDocumentPage{}

// PoliciesDocumentPage List response details for paginated document policies.
type PoliciesDocumentPage struct {
	// Number of resources returned.
	Count int32 `json:"count"`
	// One or more document policies.
	Data []PolicyDocumentResponse `json:"data"`
...
type _PoliciesDocumentPage PoliciesDocumentPage
...
func (o PoliciesDocumentPage) MarshalJSON() ([]byte, error) {
...
func (o PoliciesDocumentPage) ToMap() (map[string]interface{}, error) {
...
func (o *PoliciesDocumentPage) UnmarshalJSON(data []byte) (err error) {
	...
	varPoliciesDocumentPage := _PoliciesDocumentPage{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPoliciesDocumentPage)

	if err != nil {
		return err
	}

	*o = PoliciesDocumentPage(varPoliciesDocumentPage)

	return err
}

type NullablePoliciesDocumentPage struct {
	value *PoliciesDocumentPage
	isSet bool
}

func (v NullablePoliciesDocumentPage) Get() *PoliciesDocumentPage {
	return v.value
}

func (v *NullablePoliciesDocumentPage) Set(val *PoliciesDocumentPage) {
	v.value = val
	v.isSet = true
}

func (v NullablePoliciesDocumentPage) IsSet() bool {
	return v.isSet
}

func (v *NullablePoliciesDocumentPage) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePoliciesDocumentPage(val *PoliciesDocumentPage) *NullablePoliciesDocumentPage {
	return &NullablePoliciesDocumentPage{value: val, isSet: true}
}

func (v NullablePoliciesDocumentPage) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePoliciesDocumentPage) UnmarshalJSON(src []byte) error {
	v.isSet = true
